...
const LibrarySearch = () => {
  ...
  return (
    <div className="library-container fade-in">
      <button className="back-button" onClick={() => navigate('/library')} style={{ background: 'transparent', border: 'none', color: 'white', display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer', marginBottom: '20px' }}>
      ...
      <div style={{ display: 'flex', gap: '30px' }}>
        ...
        <div style={{ width: '250px', display: 'flex', flexDirection: 'column', gap: '20px', display: window.innerWidth > 768 ? 'flex' : 'none' }}>
        ...
        <div style={{ flex: 1, minHeight: '400px' }}>
          {loading ? (
            ...
            <div className="fade-in">
              <p style={{ color: '#a1a1aa', marginBottom: '20px' }}>Found {results.length} unified results for "{initialQuery}"</p>
